...
Now the two threads are sandwiched at the halfway point by means of a sliding piece of tape. (This tape is fixed to the threads already before you start the experiment; see @5a2001_figure_1.png.)
...
## Explanation   
@5a2001_figure_2.png shows that in the equilibrium position: $F_{\text {coulomb }}=m g \tan \varphi$.   
