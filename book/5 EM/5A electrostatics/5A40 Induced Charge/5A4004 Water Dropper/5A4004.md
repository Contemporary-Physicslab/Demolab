...
- Camera.
- Electrostatic Voltmeter (see Remarks and @5a4004_figure_2.png).
...
- The electroscope can be replaced by an electrostatic Voltmeter (see @5a4004_figure_2.png). Then the students can see directly that the voltage of the metal beaker can reach a voltage much higher than the voltage of the container from where the drops are falling. 
