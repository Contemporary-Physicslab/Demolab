...
## Presentation   
 The demonstration is set up as shown in Diagram and @5k3002_figure_1.png.     
...
Then the demonstrator makes the wire go round the core in two loops. Again the induced voltage is read and a doubling is observed. Then make the wire go round the core three times (see @5k3002_figure_2.png). And so on, as long as the length of the wire enables it.
