...
. 
```
The power supply is switched on, but the lamp shows no light. Using the voltmeter it is seen that there is no voltage across the lamp. Sliding the leads of the voltmeter along the long wires shows that all the voltage of the power supply is lost in these wires. The two identical transformers are connected into the circuit (see @5k3001_figure_1.pngB). The power supply is switched on and the lamp lights brightly!  
...
To calculate exactly we have to consider @5k3001_figure_1.pngC.
