...
- Demineralized water.
- Ohp-sheet with @5n1001_figure_2.png. 
...
## Explanation   
@5n1001_figure_2.png explains the polarized E-field that is produced by the loop dipole. This loop dipole is effectively the two-legged loop of @5n1001_figure_2.png A, but folded in a different way. Figure1E makes clear that there is a resulting E-field pulsating with a frequency of $434 \mathrm{MHz}$. The explanation is already done in the description "PresentationXX". More details can be found in the presented "SourcesXX".  
