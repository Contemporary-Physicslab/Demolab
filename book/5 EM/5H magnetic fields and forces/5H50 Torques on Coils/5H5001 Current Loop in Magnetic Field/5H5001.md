...
## Presentation   
 Using the array of compass needles we show that there is a uniform magnetic field between the permanent magnets (see @5h5001_figure_1.png).   
...
Close to the magnets the field is strongly divergent/convergent (see @5h5001_figure_2.png).   
...
. 
```
Then the coil is suspended between the two magnets (see Diagram). Connecting the power supply to the coil shows that the coil makes a rotation and lines up with the magnetic field (see @5h5001_figure_3.png). There it remains at rest.
...
. 
```
Then the coil is displaced a little from its central position: It attracts itself towards one of the magnets and sticks there (see @5h5001_figure_4.png).  
...
When the field is non-uniform, there is a radial component of $\mathrm{B}$ and there will be a net force towards the magnet (see @5h5001_figure_5.png).
