...
The Van de Graaff generator is switched on and charges the closed metal sphere. The electroscope inside shows no deflection (see @5b1002_figure_1.png).   
...
The sphere is opened by pulling one sieve away (pulling the styrofoam block) and immediately the electroscope shows a deflection (see @5b1002_figure_2.png). Closing the metal sphere again makes the deflection of the electroscope zero again.   
