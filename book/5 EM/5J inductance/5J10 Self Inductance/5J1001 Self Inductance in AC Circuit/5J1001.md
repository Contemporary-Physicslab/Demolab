...
. 
```
1. Connecting the $220 \mathrm{~V}$ to the circuit makes the lamp glows strongly (see @5j1001_figure_2.pngA ). The Voltmeter connected to the lamp reads almost $220 \mathrm{~V}$ : All voltage appears across the lamp; just a very little voltage is read across the coil.
