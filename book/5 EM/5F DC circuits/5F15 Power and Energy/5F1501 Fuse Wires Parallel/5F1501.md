...
Set up the demonstration as shown in @5f1501_figure_1.png and Diagram.
...
The power that leaves the wire to its surroundings is proportional to the surface of that wire and the $\Delta T$ to its surroundings (Newton cooling). The cooling surface $S$ equals $\pi d l$ (see @5f1501_figure_2.png).
