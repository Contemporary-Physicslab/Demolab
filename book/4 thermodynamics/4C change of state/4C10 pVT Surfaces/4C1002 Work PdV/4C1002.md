...
Then we close the cylinder and load the platform. The $2 \mathrm{~kg}$ mass goes downward (around $2 \mathrm{~cm}$ ): the gas is compressed (smaller volume; higher pressure). The $pV$ graph of the process appears (see @4c1002_figure_1.png). 
...
2. The area under the measured $pV$-graph. The software calculates it and it shows: $2097.3\mathrm{kPa\cdot ml}$ (see @4c1002_figure_2.png). The peculiar unit is rewritten and the number is rounded to $2.1 \mathrm{~J}$.
