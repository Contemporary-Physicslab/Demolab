...
```
### Preparation
Using a dripper, a large drop of water is deposited on the tabletop. The second transparent end cap is put on top of the cylinder and pressed down. The assembly is ready now (see @4c3001_figure_1.png) and the camera is focused on the drop of water.
...
Then, after some time, suddenly the drop of water turns opaque (see @4c3001_figure_2.png)
