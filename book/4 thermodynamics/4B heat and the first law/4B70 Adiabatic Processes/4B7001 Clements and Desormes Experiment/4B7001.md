...
## Explanation   
The air in the container and syringe is at room temperature $T_{0}$ and pressure $p_{0}$. Pressing the syringe raises the pressure to $p_{1}$. The manometer reads $h_{1}$. (See @4b7001_figure_1.png.)  
...
Consider this for the same $d V$ in both processes (see @4b7001_figure_1.png) and we find:

$\frac{d p_{a}}{d p_{i}}=\gamma=\frac{h_{1}}{h_{1}-h_{2}}$

## Remarks
 *  It is easy to repeat the experiment a number of times. 
 *  Instead of starting the experiment by pressing air into the container it can also be performed by sucking air out of it. (@4b7001_figure_1.png will be different, of course.)     
