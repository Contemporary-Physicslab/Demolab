...
$\mathrm{U}_{4}+\mathrm{K}_{4}+\mathrm{U}_{3}+\mathrm{K}_{3}=\mathrm{U}_{4}^{'}+\mathrm{K}_{4}{ }_{4}+\mathrm{U}_{3}^{'}+\mathrm{K}_{3}{ }^{3}$

$0+\mathrm{K}_{4}+\mathrm{U}_{3}+0=\mathrm{U}_{4}^{'}+0+0+\mathrm{K}_{3}$

so, $\mathrm{K}_{3}=\mathrm{K}_{4}+\mathrm{U}_{3}-\mathrm{U}_{4}^{'}$

$\mathrm{U}_{3}$ and $\mathrm{U}_{4}^{'}$ are both negative and $\left[\mathrm{U}_{4}\right]>\left[\mathrm{U}_{3}\right]$, making $\mathrm{K}_{3}^{'}>\mathrm{K}_{4}$. Ball 3 has the same mass as ball 4 , so when $\mathrm{K}_{3}>\mathrm{K}_{4}$, then ball 3 moves faster than ball 4.
