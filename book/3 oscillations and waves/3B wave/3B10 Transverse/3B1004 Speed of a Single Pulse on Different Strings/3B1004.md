...
## Presentation   
The demonstration is set up as shown in Diagram and @3b1004_figure_1.png.
...
## Remarks
- As presented in the picture of the Diagram, to the audience it is hard for them to see the crest traveling along the rope. Observation along the rope presents a much better view. We use the camera in such a position to make the traveling crest clearly visible (see @3b1004_figure_1.png and Diagram).
