...
- Heavy weight ( $m=25 \mathrm{~kg}$; see the construction in @3b1003_figure_1.png and @3b1003_figure_2.png).
- Tape
- Oil.
- Camera
- Projector
...
## Presentation   
Lay the long piece of hose in a straight line on the floor in front of the lecture room. On the floor, this straight line is marked by tape (see Diagram). -At one end the hose is fixed (see @3b1003_figure_1.png).  
...
- Next the hose is fixed as a loose end (see @3b1003_figure_2.png).
...
## Explanation   
- When the hose has a fixed end, an incoming pulse exerts a force on the support. The support then exerts an equal and opposite reaction force on the hose, effectively “kicking back” on it. In accordance with Newton's Third Law and conservation of Momentum, this produces a reflected pulse that travels in the reverse direction.
