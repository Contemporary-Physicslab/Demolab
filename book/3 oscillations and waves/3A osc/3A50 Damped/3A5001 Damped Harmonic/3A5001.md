...
The two graphs of position can be studied and discussed now (see @3a5001_figure_1.png). Clearly can be observed that the screen on the cart introduces more damping to the oscillating system. Also can be seen that damping reduces the frequency of the oscillation.    
