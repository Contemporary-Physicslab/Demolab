...
. 
```
Data-recording is started and the spring-mass system is set in motion again. When about 5 cycles are registered, the data-recording is stopped and the resulting position graph can be studied (see @3a4003_figure_1.pngA)
...
software we try a sine-fit (see @3a4003_figure_1.pngB). This fits very well (very low CHI2-
