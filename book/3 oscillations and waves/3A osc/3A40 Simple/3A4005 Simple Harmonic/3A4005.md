...
2. When two springs are connected in series, this combined spring will have a "new" spring constant of $k_{3}=\frac{F}{x_{1}+x_{2}}$ (see @3a4005_figure_2.png). F acts everywhere in the combined system, so $x_{1}=F / k_{1}$ and $x_{2}=F / k_{2}$. This yields $k_{3}=\frac{k_{1} k_{2}}{k_{1}+k_{2}}$.
...
3. When two springs are connected parallel: $k_{1} x_{1}+k_{2} x_{2}=F=k_{3} x$. $k_{3}=F / x$ (see @3a4005_figure_3.png), so $k_{3}=\frac{k_{1} x_{1}+k_{2} x_{2}}{x}$.
