...
## Presentation   
The prism is placed on the convex side of the $5000 \mathrm{~mm}$-lens. The camera looks almost perpendicular at a side of the prism (see Diagram). The image is projected. Concentric Newton's rings are observed (see @6d3001_figure_1.png).   
...
. 
```
Using the $5000 \mathrm{~mm}$-lens makes the curvature in @6d3001_figure_2.png much less and so the layer of air will change much slower in the $x$-direction, broadening the distance between the fringes. 
