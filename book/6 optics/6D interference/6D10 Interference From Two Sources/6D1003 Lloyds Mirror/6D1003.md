...
## Presentation   
The room is darkened and the laser is switched on. By means of the $+10 \mathrm{~mm}$-lens an illuminated disk is projected on the white screen. The surface mirror is placed parallel to the diverging light beam (see @6d1003_figure_0.png A)    
...
. 
```
and then turned just a little, so that the outer rays of the beam are reflected (see @6d1003_figure_0.png B). In the light spot on the wall the fringes are visible now.
  
  
## Explanation   
 A portion of the wavefront is reflected from S (see @6d1003_figure_1.png).     
