...
. 
```
 The pattern scanner, as described in the list of equipment,is placed in the projected beam (see @6c2001_figure_1.png) and connected to the interface to scan and record position and intensity of the image on the pc. First the intensity of the broadened laserbeam is registered (see @6c2001_figure_2.png, red line). Then the razorblade is positioned vertically, blocking half the beam and again the whole pattern is scanned (see @6c2001_figure_2.png, green line).   
