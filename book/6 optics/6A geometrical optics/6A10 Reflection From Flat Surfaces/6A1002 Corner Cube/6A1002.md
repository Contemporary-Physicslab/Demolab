...
a right-handed coordinate system is converted into a left-handed one (see @6a1002_figure_1.png).  
...
@6a1002_figure_2.png shows that reflection in three mutually perpendicular mirrors  $(x z, x y, y z)$ will produce ray (vector) inversion. Three reflections occur:
