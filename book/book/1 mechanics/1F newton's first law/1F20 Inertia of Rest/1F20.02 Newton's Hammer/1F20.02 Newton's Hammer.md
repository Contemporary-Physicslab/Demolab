...
## Presentation   
This demonstration is an exciting variant to the traditional [tablecloth pull](<../1F20.01 Tablecloth Pull/1F20.01 Tablecloth Pull.md>): Very little is needed to topple the balanced hammer.

The sheet op paper is placed on the table and the hammer is balanced on it (see [Diagram](#diagram)). For the audience it is clearly observable that it takes care to balance the hammer with its head up; a slight disturbance makes it fall.
