...
## Presentation   
 ...
 3. Remove the wire with mass from the cart. Incline the track using table clamp and rod (see [Diagram](#diagram)). Hold the cart at the top of the incline and load the ball. Ask the students: "Will the ball be caught after launching, yes or no". Release the cart. Also now, after launching the ball, it will land in the cart. 
