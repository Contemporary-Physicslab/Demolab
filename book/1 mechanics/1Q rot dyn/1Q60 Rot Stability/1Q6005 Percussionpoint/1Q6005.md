...
## Equipment
- Baseball bat and "cradle" (see @1q6005_figure_1.pngA).
- Meter stick.
...
2. The baseballbat has a hole drilled in its shaft at the point between the two hands that would grasp the bat. In this hole a bar is stuck, extending on both sides. These ends rest on the flat surfaces of the "cradle" (see @1q6005_figure_1.pngA), so the bat can rock to and fro.   
