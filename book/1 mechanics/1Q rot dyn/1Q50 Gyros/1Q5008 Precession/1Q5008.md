...
## Explanation   
The rotating wheel will precess due to gravitational torque, $m g s$ ( $I \omega_{0}$ moves in the direction of this gravitational torque; precession) (see @1q5008_figure_1.png A).   
...
$F$ is the applied force in the direction of precession (see @1q5008_figure_1.png B). The applied torque is pointing vertically upward, so now $I \omega_{0}$ moves also upward.  
