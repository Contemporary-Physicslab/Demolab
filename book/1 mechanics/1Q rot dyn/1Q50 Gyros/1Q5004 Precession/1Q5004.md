...
## Explanation   
Because Angular momentum is a vector quantity and can be represented by a vector parallel to the axis of spin, two angular momentum vectors can be combined using the parallelogram law. Therefore, when a gyroscope experiences a torque tending to rotate it about an axis perpendicular to its spin axis, it responds by precessing about a third axis perpendicular to the other two.
...
. 
```
The spinning wheel has an angular momentum of $I \omega_{0}$. This is represented by a vector parallel to the axis of spin (see  @1q5004_figure_1.png a). When one of the strings is cut, then gravitational torque ( $\mathrm{mgs}$ ) is added to the system (see  @1q5004_figure_1.png b ). This torque tends to change $I \omega_{0}$, so $I \omega_{b}$ moves into the direction of $m g s$ (see  @1q5004_figure_1.png c).
