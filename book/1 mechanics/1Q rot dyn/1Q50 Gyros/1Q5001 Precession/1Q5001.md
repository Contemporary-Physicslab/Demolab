...
The spinning gyroscope has an angular momentum of $I\omega_0$. This is represented by a vector parallel to the axis of spin (see @1q5001_figure_1.pnga).   
...
. 
```
When the centre of mass ($\mathrm{~CM}$) is above the point of support, then there is a gravitational torque mgs (see @1q5001_figure_1.pngb), pointing away from you. 
