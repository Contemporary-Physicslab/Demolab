...
The spinning gyroscope has an angular momentum of $I\omega_0$. This is represented by a vector parallel to the axis of spin (see @1q5001_figure_1.png A).   
...
. 
```
When the centre of mass ($\mathrm{~CM}$) is above the point of support, then there is a gravitational torque mgs (see @1q5001_figure_1.png B), pointing away from you. 

This torque tends to change $I\omega_0$, so $I\omega_0$ moves into the direction of $mgs$ (see @1q5001_figure_2.png), 
