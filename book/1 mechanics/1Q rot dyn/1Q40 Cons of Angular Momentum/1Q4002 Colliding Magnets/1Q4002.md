...
## Presentation   
 Slide across the table (or floor) one ring towards the other to make a glancing collision. The two magnets stick together and rotate about their common center of mass (see @1q4002_figure_1.png). (No rotation is observed for head-on collisions.)    
 ...
 *  We have taped the sides of the magnets in order to prevent damage when the magnets collide. (See @1q4002_figure_1.png)
