...
```{figure} figures/PICT0656 - Copy.JPG
:width: 70%
...
The centrifugal force $\left(F_{C}\right.$ ) acting on the ball is given by $F_{C}=m R \omega^{2}$ ( $R$ being the perpendicular distance from the axis of rotation to the center of the ball). The force on the ball along the ramp is $F_{r}=m g \sin \theta-\cos \theta$ (see @1q4005_figure_1.png). So:
