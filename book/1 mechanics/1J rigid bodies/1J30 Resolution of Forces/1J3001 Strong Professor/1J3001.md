...
3. A piece of rope, that cannot be broken by hand, is tightly knotted around the top of a table (see @1j3001_figure_2.png B). A metal bar is stuck under it and when the bar is pulled upwards, the rope breaks easily. 
...
1. Equilibrium requires that there is resolution of force (see @1j3001_figure_1.png). The students need a large force to cancel the small force of the professor.
2. In equilibrium the force downward should be in the direction of the bars ( $F_{1}$ and $F_{2}$ in @1j3001_figure_2.png). The horizontal components of these forces give the tension $T$ in the thread. $F_{1}$ and $F_{2}$ are the components of force along the bars of the professor's force $P$. The more the bars are pressed downward, the higher the components $F_{1}$ and $F_{2}$ will be and the higher the tension $T$ in the thread.
