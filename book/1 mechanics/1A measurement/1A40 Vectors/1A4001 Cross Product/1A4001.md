...
Visualize the result of a cross product of two vectors.    
...
```{figure} figures/PICT0653 - Copy.JPG
...
*  The small white model is used in case of explaining Coriolis force in combination with a globe (see @1A4001_figure_1).  
