...
## Explanation   
The ping-pong ball, being completely immersed in water, experiences an upward buoyant force $F_u$ that is greater than its weight $m \cdot g$. The net force ($F_u - m \cdot g$) is directed upwards. The tension $T$ in the string prevents the ping-pong ball from floating upwards (see @1d5003_figure_2.pnga).
