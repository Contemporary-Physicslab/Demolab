...
*  Bent rail track on frame, with "ball catcher" (plastic coffee cup) and a pointer fixed to it (see @demo1D4001_figure_0.png). The bent rail track is fixed firmly to the two carts. Ensure that the two carts are neatly aligned. 
