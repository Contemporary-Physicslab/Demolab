...
***Presentation***   
A ceramic magnet is added to the setup and firmly fixed to the rail (see @1m4001_figure_1.png C). The fourth ball slowly rolls towards the ceramic magnet, hits and ball three rolls away with a much higher speed!

When in @1m4001_figure_1.png C ball 4 is stuck to the magnet, the approaching ball 3 will not launch ball 4.
...
## Explanation   
The magnet exerts an attractive force on the steel balls. When a ball sticks to the magnet a force is needed to make it loose. In terms of potential energy the magnet is a well (see @1m4001_figure_2.png).
...
@1m4001_figure_2.png visualizes the energy conservation in such a way.
## Remarks
...
- ***Extra demonstration***
    ...
    Is reversing the demonstration possible? (see @1m4001_figure_1.png D). So, when rolling ball 3, can we launch ball 4 ?

    The preceding demonstration suggests that to make that happen, ball 3 should have a high speed and 4 will be launched with a low speed (reverse the energy diagram of @1m4001_figure_2.png). But this will not happen. No matter how high the speed of ball 3, ball 4 will never escape its potential energy well.
