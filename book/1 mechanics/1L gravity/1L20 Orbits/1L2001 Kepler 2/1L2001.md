...
## Presentation   
 By means of the software program an elliptical orbit is projected (see @1l2001_figure_1.png A). The speed in the orbit is visualized when in the orbit points are plotted at constant time-intervals. This orbit is also plotted when the time-interval applied is 16 times larger (@1l2001_figure_1.png B).  
...
Consider the area in @1l2001_figure_2.png swept by the vector $r$ in a time $\Delta t$.
