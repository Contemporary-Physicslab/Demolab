...
## Presentation   
 By means of the software program an elliptical orbit is projected (see @1l2001_figure_1.pngA). The speed in the orbit is visualized when in the orbit points are plotted at constant time-intervals. This orbit is also plotted when the time-interval applied is 16 times larger (@1l2001_figure_1.pngB).  
