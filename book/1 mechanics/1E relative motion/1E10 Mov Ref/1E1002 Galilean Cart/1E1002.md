 ...
 *  The same demonstration is performed, but now with the funnel-pendulum swinging into the $y'$-direction. A second salt-track appears on the floor (see @1e1002_figure_1.png). 
...
- When the pendulum swings into the $y^{'}$-direction, the movements in the $x$-y-zframe will be: $y=V t+A \sin (\omega t+\phi) ; x=0$ and $z=0$ (see @1e1002_figure_2.png).   
...
## Remarks
 *  As @1e1002_figure_1.png makes clear, the difference between much - and little salt is more pronounced when $y=V t$ is steeper; that is at higher speeds of the cart.   
