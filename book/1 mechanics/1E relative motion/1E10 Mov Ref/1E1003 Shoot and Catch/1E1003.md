...
## Explanation   
 1. The cart and ball have the same horizontal component of velocity. The horizontal component of acceleration of both cart and ball is zero, so ball and cart remain aligned (see @1e1003_figure_1.png).  
...
```
 ...
 3. When the track is tilted, the cart and ball have the same component of acceleration parallel to the track (see @1e1003_figure_2.png). Since they have the same initial parallel-component velocity and the same parallel-component acceleration, they will always keep the same parallel-component velocity. The ball will always be in line with the cart, perpendicular to the track, and it will be caught.    
...
. 
```
 4. The same holds for the cart moving upward. So again see @1e1003_figure_2.png.   
