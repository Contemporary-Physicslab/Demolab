...
- Clamping material.
- Two overhead sheets (see @1e2002_figure_2.png A, B).
...
From the perspective of someone “living” on the rotating platform, the cause of the ball’s counterclockwise curvature is called the *Coriolis force*. (You will probably need to repeat this part of the demonstration to help your students clearly observe it.) When the board rotates counterclockwise, the ball’s curvature on the platform will be clockwise.
 ...
 Next the ramp is fixed to the rotating platform. Several directions of launching the steel ball can be shown then (see @1e2002_figure_1.png). 
...
```
 ...
 We also show prepared overhead sheets to elucidate the curvature more exactly. (See @1e2002_figure_2.png A, B and C. @1e2002_figure_2.png C shows how the path on the rotating sheet/platform can be constructed: On sheet {numref}` {number} <1e2002_figure_2.png A the "ball" moves with a constant speed; on sheet {numref}`{number} <1e2002_figure_2.png C there is a rotation of $10^{\circ}$ for every $2 \mathrm{~cm}$ displacement on {numref}` {number} <1e2002_figure_2.png A). Also, on these sheets, the counterclockwise curvature is clear.

2. $\vec{F}_{\text {cor }}=2 m\left(\vec{v}^{'} \times \vec{\omega}\right)$. $\vec{v}^{'}$ and $\vec{\omega}$ are continuously perpendicular to each other. @1e2002_figure_3.png shows the direction of the resulting $F_{\text {cor }}$. So $F_{c o r}$ points as seen from $\bar{v}^{'}$ continuously to the left, giving $m$ a counterclockwise path.
