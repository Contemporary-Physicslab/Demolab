...
The cover glass rests against the wooden block (see @1n1005_figure_0 A). By hand, the inclination of the cover glass is decreased by pulling the wooden block very slowly to the right (see @1n1005_figure_0 B). At a certain moment the cover glass starts sliding: It moves downwards and away from the wooden block. Pose the question to the students: "What makes the cover glass move away from the wooden block?"   
  
## Explanation   
During the sliding movement, five forces are acting: The weight $G$, the normal forces $N_A$ and $N_B$ and the friction forces in $A$ and $B$ (see @1n1005_figure_1; the friction forces are neglected).   
