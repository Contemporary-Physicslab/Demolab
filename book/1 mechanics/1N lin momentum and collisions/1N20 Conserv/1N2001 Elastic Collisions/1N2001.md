...
This rule can easily be verified in applying conservation of momentum and conservation of kinetic energy. This method is shown here for situation 1 only, for the other situations the result is shown (see @1n2001_figure_1.png and @1n2001_figure_2.png). @1n2001_figure_2.png shows the observed $-v_{1}$ and $v_{2}$ after the collision.
