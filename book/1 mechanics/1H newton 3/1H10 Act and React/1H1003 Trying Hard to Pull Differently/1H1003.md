...
Two demonstrators take each of the sensors. They start both pulling randomly. The display shows clearly that whatever they do, both force sensors measure the same force: $-F$ and $-F$ (see @1h1003_figure_1.png).  
