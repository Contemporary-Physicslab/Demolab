...
- In the right graph of @1h1001_figure_1.png can be seen which cart has the spring mounted to its force sensor: A damped vibration is seen after the collision. The force sensor itself also vibrates after the collision, as shown in the graph of the other force sensor.
