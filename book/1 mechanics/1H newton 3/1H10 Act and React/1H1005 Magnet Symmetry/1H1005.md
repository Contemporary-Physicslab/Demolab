 ...
 *  The symmetric pattern provides evidence of both a mutual force and a mutual torque. The symmetric separation of the objects confirms Newton's Third Law. That the magnets are not equally strong does not change the equality of action and reaction force magnitudes. 
...
## Remarks
*  Releasing the two magnets needs some practice (see @1h1005_figure_1.png); both fingers need to move away from the magnets simultaneously.    
