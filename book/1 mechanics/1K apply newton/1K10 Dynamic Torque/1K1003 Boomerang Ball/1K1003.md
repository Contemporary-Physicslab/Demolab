...
Having hit the vertical wall the ball climbs steep (see @1k1003_figure_1.pngA). A parabolic trajectory follows. On hitting the floor in $\mathrm{R}$, the friction force is directed to the right (@1k1003_figure_1.pngB). The impulse $\int F_{r} d t$ is large enough to make the component
